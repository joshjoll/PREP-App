...
urlpatterns = [
    ...
    path('projects/<int:project_id>/', views.Project_Detail.as_view(), name='detail' ),
    path('projects/new/', views.New_Project.as_view(), name='new_project' ),
    path('projects/<int:project_id>/technology/', views.Add_Technology.as_view(), name='technology' ),
    path('projects/<int:project_id>/image/', views.Add_Image.as_view(), name='image' ),
